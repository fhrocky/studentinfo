...
if (isset($_POST['btnAdd'])) {
  ...
  mysqli_query($connect, "INSERT INTO students(name, email, mobile,password) VALUES ('$std_name','$std_email','$std_mobile','$std_password')");
  ...
  <div class="sign-up-form">
    <form action="" class="std" method="POST">
      <fieldset>
        ...
        <input type="submit" name="btnAdd" class="btn" value="Sign Up" />
    </form>
    </fieldset>
  </div>
</body>
